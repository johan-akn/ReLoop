...
export function InfoItem({ item, onClose }) {
 ...
 <div className="info-seller-section">
 <span className="info-section-title">Anunciante</span>
 <div className="info-seller-card">
 <div className="info-seller-avatar">
 <User size={24} />
 </div>
 <div className="info-seller-details">
 <p className="info-seller-name">{seller?.nome}</p>
 <p className="info-seller-phone">
 <Phone size={14} />
 {seller?.telefone}
 </p>
 </div>
